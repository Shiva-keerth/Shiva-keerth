...
| 🧠 [BERT Product Recommender](https://github.com/Shiva-keerth) | Python, BERT, Sentence-Transformers, Cosine Similarity | Built a semantic product recommendation engine using NLP sentence embeddings and cosine similarity for intelligent, context-aware search. |
| 💬 [WhatsApp Intent Chatbot](https://github.com/Shiva-keerth) | Python, TensorFlow, Keras, Bi-LSTM, NLP | Trained a deep learning chatbot on raw WhatsApp conversations using a Bidirectional LSTM network for accurate intent classification and auto-responses. |
| 👁️ [AI Doodle (Air Drawing)](https://github.com/Shiva-keerth) | Python, OpenCV, MediaPipe, NumPy | Developed a real-time computer vision system allowing users to draw in thin air using hand-gesture recognition and spatial tracking. |
